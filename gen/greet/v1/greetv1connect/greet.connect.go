...
import (
	v1 "connect-lambda-localstack-demo/gen/greet/v1"
...
const (
	...
	// GreetServiceGetTimeProcedure is the fully-qualified name of the GreetService's GetTime RPC.
	GreetServiceGetTimeProcedure = "/greet.v1.GreetService/GetTime"
)
...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		...
		getTime: connect.NewClient[v1.GetTimeRequest, v1.GetTimeResponse](
			httpClient,
			baseURL+GreetServiceGetTimeProcedure,
			connect.WithSchema(greetServiceMethods.ByName("GetTime")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
// GetTime calls greet.v1.GreetService.GetTime.
func (c *greetServiceClient) GetTime(ctx context.Context, req *connect.Request[v1.GetTimeRequest]) (*connect.Response[v1.GetTimeResponse], error) {
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	greetServiceGetTimeHandler := connect.NewUnaryHandler(
		GreetServiceGetTimeProcedure,
		svc.GetTime,
		connect.WithSchema(greetServiceMethods.ByName("GetTime")),
		connect.WithHandlerOptions(opts...),
	)
	return "/greet.v1.GreetService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case GreetServiceGetTimeProcedure:
			greetServiceGetTimeHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedGreetServiceHandler) GetTime(context.Context, *connect.Request[v1.GetTimeRequest]) (*connect.Response[v1.GetTimeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("greet.v1.GreetService.GetTime is not implemented"))
}
